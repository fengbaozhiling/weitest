...
define([
    ...
    'models/energy',
    'text!tpl/list.html',
    'text!tpl/horn_message.html'
], function (doT, dialog, Hammer, api, Alert, Biu, countDown, EnergyBox, QueueBox,  ChatModel, ListModel, UserModel, Energy, tpl,hornMessageTpl) {
