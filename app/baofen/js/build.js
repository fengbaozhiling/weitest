...
/***/ function(module, exports, __webpack_require__) {
	...
	var RewardRules = __webpack_require__(23);
	var JcView = __webpack_require__(25);
	var JcQcView = __webpack_require__(27);
	var ListView = __webpack_require__(29);
	var ToolView = __webpack_require__(48);
	var ToolDetailView = __webpack_require__(51);
	var IndexView = __webpack_require__(53);
	var Qcode = __webpack_require__(55);
	var Withdraw = __webpack_require__(58);
	var QcodeUpload = __webpack_require__(61);
	var ApprenticesView = __webpack_require__(64);
	var ChatView = __webpack_require__(67);
	var MenuView = __webpack_require__(72);
	var WithdrawList = __webpack_require__(74);
	var RankView = __webpack_require__(77);
	var OfficialAccounts = __webpack_require__(79);
	var OfficialAccountsDtail = __webpack_require__(81);
	var PlacardView = __webpack_require__(83);
	var PlacardWelcomeView = __webpack_require__(88);
	...
	module.exports = Backbone.Router.extend({
	    ...
	    reward: function (page) {
	        var page = page ? page : 1;
	        this.cached.rewardView.fetch(page);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tpl_page = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Biu = __webpack_require__(31);
	var Hammer = __webpack_require__(32);
	var api = __webpack_require__(7);
	var countDown = __webpack_require__(34);
	var EnergyBox = __webpack_require__(36);
	var QueueBox = __webpack_require__(38);
	var ChatModel = __webpack_require__(40);
	var ListModel = __webpack_require__(41);
	var UserModel = __webpack_require__(19);
	var Energy = __webpack_require__(42);
	var tpl = __webpack_require__(43);
	var hornMessageTpl = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// magical touchAction value
	    ...
	    if ("function" == TYPE_FUNCTION && __webpack_require__(33)) {
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
	            return Hammer;
	        }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    } else if (typeof module != 'undefined' && module.exports) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * */
	var count = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var Tool = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dialog = __webpack_require__(9);
	var api = __webpack_require__(7);
	var cash = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var Apprentices = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var dialog = __webpack_require__(9);
	var chatMode = __webpack_require__(40);
	var Horn = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var tpl = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dialog = __webpack_require__(9);
	var api = __webpack_require__(7);
	var WithModel = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(7);
	var footBarCrent = __webpack_require__(15);
	var rank = __webpack_require__(78);
	var tpl = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var Public = __webpack_require__(80);
	var tpl = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var doT = __webpack_require__(6);
	var dialog = __webpack_require__(9);
	var PlacardRank = __webpack_require__(84);
	var Cash = __webpack_require__(85);
	var footBarCrent = __webpack_require__(15);
	var tpl = __webpack_require__(86);
	var tplRank = __webpack_require__(87);
	...
	module.exports = Backbone.View.extend({
	    ...
	    tagName: 'div',
	    events:{
	        'click .footer-line .iconfont': function() {
	            var html = '<div class="alert-out alert-out-info">' +
	                '<span class="text-danger">若可提现金额小于提现额度不能提现</span><br>1、必须满足积分超过100分，即最低1元方可提现；<br>2、推广的团员输入接头暗号后即可随机获得一个5-50积分；<br>3、团员入团后1天结算积分；<br>4、您可自主提现，提现金额转到微信零钱；<br>5、财神道拥有本活动最终解释权' +
	                '</div>';
	            var d = new dialog ({
	                title:'积分说明',
	                content:html,
	        ...
	        * 显示积分规则提示
	        * */
	        'click .my-row .iconfont' : function(e) {
	            var target = e.target;
	            var d = new dialog ({
	                title:'说明',
	                content:$(target).data('msg'),
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"img-placard\">\r\n    <div class=\"inner\">\r\n        <img class=\"img-responsive text\" src=\"{{=globConfig.imageUrl}}/text_img.png\" alt=\"\"/>\r\n    </div>\r\n    <img class=\"img-responsive\" src=\"{{=globConfig.imageUrl}}/haibao_banner.jpg\" alt=\"\"/>\r\n</div>\r\n<div class=\"za-container\">\r\n    <h3>第一步</h3>\r\n    <p>长按下方图片，在弹出菜单中选择“保存图片”将图片保存到您手机上</p>\r\n    <div class=\"alert-out alert-out-info\">\r\n        <img class=\"img-responsive\" src=\"{{=it.qrcode}}\">\r\n    </div>\r\n    <h3>第二步</h3>\r\n    <p>将图片通过朋友圈或群发（微信工具栏里有群发功能，一次可以发150人）的方式发送给好友，好友通过此图片里二维码关注公众号后，点击进入游戏页面输入您的接头暗号，您将随机获得数量5~50不等的积分</p>\r\n    <h3>第三步</h3>\r\n    <p>积满100积分可兑换1元现金，即可点击提现，满百整兑，以此类推。</p>\r\n</div>\r\n\r\n\r\n<div class=\"footer-line\">\r\n    <span class=\"pull-right\"><a class=\"za-btn za-btn-danger\" href=\"#withdraw/1\">提现</a></span>\r\n    当前积分：{{=it.integral}} <i class=\"iconfont icon-wenhao01\"></i>\r\n</div>";

/***/ },
/* 87 */
/***/ function(module, exports) {

	module.exports = "{{? !it}}\r\n<div class=\"sk-three-bounce\">\r\n    <div class=\"sk-child sk-bounce1\"></div>\r\n    <div class=\"sk-child sk-bounce2\"></div>\r\n    <div class=\"sk-child sk-bounce3\"></div>\r\n</div>\r\n{{??}}\r\n<nav class=\"za-nav\">\r\n    <a href=\"#/placard/myteam\"><span>我的军团</span></a>\r\n    <a href=\"#/placard/all\"><span>世界排名</span></a>\r\n</nav>\r\n{{ for (var key in it.data) { }}\r\n<div class=\"za-media rank-list\">\r\n    <div class=\"za-media-left\">\r\n        <img class=\"media-object\" src=\"{{=it.data[key].headimgurl}}\">\r\n    </div>\r\n    <div class=\"za-media-body {{? it.group == 'myteam'}}{{? it.data[key].status == 1}}settled{{??}}not-settled{{?}}{{?}}\" >\r\n        <h4>{{=it.data[key].nickname}} </h4>\r\n        <p class=\"time-info\">{{? it.group == 'myteam'}}入团时间{{??}}建团时间{{?}}：{{=it.data[key].join_time}}</p>\r\n    </div>\r\n    <div class=\"za-media-right\">\r\n        <div class=\"text-right\">\r\n            {{? it.group == 'myteam'}}贡献{{??}}总积分{{?}}<br>\r\n            <span class=\"text-danger\">{{=it.data[key].integral}}</span>\r\n        </div>\r\n    </div>\r\n</div>\r\n{{ } }}\r\n{{? it.group == 'myteam'}}\r\n<div class=\"my-row\">\r\n    <b>军团累计积分<i data-msg=\"军团累计积分=已结算积分+未结算积分\" class=\"iconfont icon-wenhao01\"></i>:</b>\r\n    <span class=\"text-danger\">{{=it.all_integral}}</span>\r\n</div>\r\n<div class=\"my-row\">\r\n    <b>已结算积分<i data-msg=\"所有入团满{{=it.settle_cycle}}天的团员贡献总额\" class=\"iconfont icon-wenhao01\"></i>:</b>\r\n    <span class=\"text-danger\">{{=it.settled}}</span>\r\n</div>\r\n<div class=\"my-row\">\r\n    <b>未结算积分<i data-msg=\"所有入团未满{{=it.settle_cycle}}天的团员贡献的积分\" class=\"iconfont icon-wenhao01\"></i>:</b>\r\n    <span class=\"text-danger\">{{=it.not_settled}}</span>\r\n</div>\r\n{{?}}\r\n{{ } }}";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dialog = __webpack_require__(9);
	var api = __webpack_require__(7);
	var tpl = __webpack_require__(89);
	var getQuery = __webpack_require__(90);
