...
gulp.task('less', function () {
    return gulp.src('../../less/list.less')
        .pipe(less())
        .pipe(gulp.dest('./css'));
});
...
gulp.task('image', function () {
    return gulp.src('./images/**/*')
        ...
        .pipe(gulp.dest('../../dist/list/images'));
});
...
gulp.task('watch', function () {
    ...
    gulp.watch([ './index.html', './css/list.css.css'], function (e) {
        server.changed({
            body: {
                files: [e.path]
            }
...
gulp.task('minify-css', function() {
    return gulp.src('./css/list.css')
        .pipe(minifyCss({compatibility: 'ie8'}))
        .pipe(gulp.dest('../../dist/list/css'));
});
/*
* minify-lib
* */
